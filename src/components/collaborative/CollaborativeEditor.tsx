...
import { setupAutoSave, getLatestSnapshot } from '@/lib/snapshots';
...
export default function CollaborativeEditor({ noteId, onTitleChange }: CollaborativeEditorProps) {
  const { user } = useAuth();
  ...
  const editor = useEditor({
    extensions: [
      ...
      ...(collaborationReady && ydocRef.current && user ? [
        ...
        // Temporarily disable CollaborationCursor to fix the setLocalStateField error
